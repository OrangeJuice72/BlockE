...
const Leases = ({ user }) => {
  ...
  const [pendingLease, setPendingLease] = useState(null);
  ...
  const handleExportConfirm = () => {
    ...
    generateICS(pendingLease.tenant, pendingLease.unit, pendingLease.date, pendingLease.rent, exportTime);
  ...
  return (
    <>
      ...
      <CalendarExportModal
        isOpen={Boolean(pendingLease)}
        time={exportTime}
        onTimeChange={setExportTime}
